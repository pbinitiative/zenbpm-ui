...
const createInstance = (
  ...
  const history = [
    ...
    },
    {
      ...
      state: (stoppedAt === 'assignee-task' ? state : 'completed') as 'active' | 'completed' | 'terminated' | 'failed',
      ...
      ? [
          {
            ...
            elementType: 'userTask',
            state: (stoppedAt === 'group-task' ? state : 'completed') as 'active' | 'completed' | 'terminated' | 'failed',
