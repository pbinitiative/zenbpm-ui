...
export const jobs = [
  {
    ...
    inputVariables: { employeeId: 'EMP-001', employeeName: 'Sarah Johnson', requestType: 'vacation' },
    assignee: 'john.doe',
  ...
  },
  {
    ...
    inputVariables: { employeeId: 'EMP-002', employeeName: 'Mike Davis', requestType: 'equipment' },
    candidateGroups: ['sales', 'marketing', 'support'],
  },
  {
    ...
    inputVariables: { employeeId: 'EMP-101', employeeName: 'James Wilson' },
    assignee: 'john.doe',
    candidateGroups: ['sales', 'marketing', 'support'],
  },
  {
    ...
    inputVariables: { employeeId: 'EMP-301', employeeName: 'William Clark' },
    assignee: 'john.doe',
    candidateGroups: ['sales', 'marketing', 'support'],
  },
  {
    ...
    inputVariables: { employeeId: 'EMP-302', employeeName: 'Mia Lewis' },
    candidateGroups: ['sales', 'marketing', 'support'],
  },
  {
    ...
    inputVariables: { employeeId: 'EMP-304', employeeName: 'Evelyn Hall' },
    assignee: 'john.doe',
    candidateGroups: ['sales', 'marketing', 'support'],
  },
];
